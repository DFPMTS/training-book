...
#book-meta(
  ...
  summary: [
    ...
    - #chapter("chapters/ooo/impl-5stage.typ", section: "3.2.1")[五级流水基础]
    - #chapter("chapters/ooo/impl-multi-issue.typ", section: "3.2.2")[多发射]
    - #chapter("chapters/ooo/impl-scoreboard.typ", section: "3.2.3")[记分牌算法]
    - #chapter("chapters/ooo/impl-tomasulo.typ", section: "3.2.4")[Tomasulo算法与流水级定义]
    - #chapter("chapters/ooo/impl-optimization.typ", section: "3.2.5")[优化]
    = 频率与IPC优化
